...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bounty'
        db.create_table(u'requests_bounty', (
        ...
        db.send_create_signal(u'requests', ['Bounty'])

        # Adding field 'Request.supplier'
        db.add_column(u'requests_request', 'supplier',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'requests_bounty')

        # Deleting field 'Request.supplier'
        db.delete_column(u'requests_request', 'supplier_id')
    ...
    models = {
        ...
        u'catalog.resource': {
            'Meta': {'ordering': "('-last_updated',)", 'object_name': 'Resource'},
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'newest_record': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'oldest_record': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'requests.request': {
            ...
            'agency_division': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'agency_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'agency_type': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            ...
            'supplier': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
