...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.newest_record'
        db.add_column(u'catalog_resource', 'newest_record',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Resource.oldest_record'
        db.add_column(u'catalog_resource', 'oldest_record',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.newest_record'
        db.delete_column(u'catalog_resource', 'newest_record')

        # Deleting field 'Resource.oldest_record'
        db.delete_column(u'catalog_resource', 'oldest_record')
