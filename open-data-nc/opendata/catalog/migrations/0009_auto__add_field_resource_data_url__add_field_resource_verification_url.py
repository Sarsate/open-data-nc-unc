...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.data_url'
        db.add_column(u'catalog_resource', 'data_url',
                      self.gf('django.db.models.fields.URLField')(null=True, blank=False))

        # Adding field 'Resource.verification_url'
        db.add_column(u'catalog_resource', 'verification_url',
                      self.gf('django.db.models.fields.URLField')(null=True, blank=False))
    ...
    models = {
        ...
        u'catalog.resource': {
            ...
            'data_url': ('django.db.models.fields.URLField', [], {'null': 'True', 'blank': 'False'}),
            ...
            'verification_url': ('django.db.models.fields.URLField', [], {'null': 'True', 'blank': 'False'}),
